...
class _PagesTestWidgetState extends State<PagesTestWidget> {
  ...
  void _selectTab(int tabItem) {
    setState(() {
      ...
      switch (tabItem) {
        case 0:
         // widget.currentPage = ReturnWidget(parentScaffoldKey: widget.scaffoldKey);
          break;
        case 1:
          ...
          items: [
            ...
            BottomNavigationBarItem(
              ...
              Container(
                ...
                child: Center(child:Text("Completed",style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold), )),
              ),
              title: new Container(height: 0.0),
            ),
          ],
